    ...
    <div className="bg-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
        <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
          <span className="block text-[#2F80ED]">Ready to Build Your AI Workforce?</span>
          <span className="block text-[#9B51E0] mt-1">Join the AI Workforce Academy today.</span>
        </h2>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="px-6 py-8">
              <div className="flex items-center">
                <div className="flex-shrink-0 bg-[#2F80ED] rounded-md p-3">
              ...
              <div className="mt-6">
                <Link href="#" className="text-[#2F80ED] hover:text-[#2967c7] text-sm font-medium">
                  Learn more →
                </Link>
              </div>
            </div>
